...
// Mobile Product Card Component - Optimized for 2 columns
    ...
    >
      <div className="relative w-full h-32 overflow-hidden">
        ...
        <span className={`absolute top-1 left-1 px-1.5 py-0.5 rounded-full text-[10px] font-medium ${getConditionBadgeColor(product.condition)}`}>
          {product.condition === "Fairly Used" ? "F.Used" : product.condition === "fairly used" ? "F.Used" : product.condition?.slice(0, 4)}
        </span>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-yellow-600">
              Why a subscription? Your subscription goes directly toward marketing your store and bringing serious buyers to you.
            </p>
          </div>
        </div>
        <button
    ...
    <section className="pt-0 pb-8 md:py-8 bg-gray-50">
      ...
      <div className="block md:hidden px-3 mt-4">
        ...
        <div className="flex items-center justify-between gap-2 mb-4">
          ...
          <button
            onClick={clearFilters}
            className="text-red-500 text-xs font-medium px-2 py-2"
          >
            Reset
          </button>
        </div>
          ...
          <div className="flex items-center justify-between mt-3 pt-2 border-t border-gray-100">
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              <div className="w-9 h-5 bg-gray-300 peer-focus:outline-none rounded-full peer peer-checked:bg-green-500 transition-all duration-300">
                <div className={`absolute top-0.5 left-0.5 w-4 h-4 bg-white rounded-full transition-all duration-300 ${filters.verifiedSeller ? 'translate-x-4' : ''}`}></div>
              </div>
            </label>
          </div>
        </div>
